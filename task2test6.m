...
data1_neg = s1 * [1, -1; -1, 1]; % Negate Y values for negative correlation
data2_neg = s2 * [1, -1; -1, 1];
...
% Create 3D plots for the PDFs (negative correlation)
subplot(2, 2, 3);
surf(x, y, pdf_neg1);
...
zlim([0, max([pdf_pos1(:); pdf_pos2(:); pdf_neg1(:); pdf_neg2(:)])]);
